...
class CreateFlutterWaveSubAccount extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => WalletBloc(walletRepository: WalletRequests(),
          viewWalletRepository: ViewWalletRequest()),
      child: CreateFlutterWaveSubAccountPage(),
    );
  }
}

// ignore: must_be_immutable
class CreateFlutterWaveSubAccountPage extends StatelessWidget {
  ...
  final businessPhoneOneController = TextEditingController();
  final businessPhoneTwoController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    _walletBloc.add(ViewFlutterWaveSubAccountEvent());
    _walletBloc.add(GetFlutterWaveBankCodes());
    return Scaffold(
        appBar: AppBar(
          elevation: 0.0,
          ...
          title: Text('Create FlutterWave Account', style: TextStyle(color: MyColors.primaryColor)),
        ),
        body: CustomPaint(
                          ...
                          Column(
                            ...
                            children: <Widget>[
                                ...
                                listener: (BuildContext context, WalletStates state) {
                                  if (state is BankSelected) {
                                    ...
                                    if(state.subAccount!=null){
                                      ...
                                      businessEmailController.text=state.subAccount.email;
                                      businessAddressController.text=state.subAccount.address;
                                      businessPhoneOneController.text=state.subAccount.phoneOne;
                                      businessPhoneTwoController.text=state.subAccount.phoneTwo;
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      prefixIcon: Icon(Icons.location_on,
                                          color: Colors.blue),
                                      labelText: 'Business contact address',
                                      labelStyle: new TextStyle(
                                          color: Colors.grey[800]),
                                      filled: true,
                                      fillColor: Colors.white70),
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: TextFormField(
                                  controller: businessPhoneOneController,
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: TextFormField(
                                  controller: businessPhoneTwoController,
                                  keyboardType: TextInputType.phone,
                                  validator: (value) {
                                    if (value.isEmpty) {
                                      return 'Please enter business mobile.';
      ...
      child: RaisedButton(
        onPressed: () {
          if (_formKey.currentState.validate()) {
            if (validateSpinner()) {
              _walletBloc.add(RegisterFlutterWaveSubAccountEvent(banksSpinnerIds[banksSpinnerItems.indexOf(banksDropdownValue)], accountNumberController.text, businessNameController.text, businessEmailController.text, businessAddressController.text, businessPhoneOneController.text, businessPhoneTwoController.text));
            }
          }
        },
